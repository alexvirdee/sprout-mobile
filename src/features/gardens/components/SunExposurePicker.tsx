/**
 * SunExposurePicker — full-width selectable rows for sun exposure (emoji + label
 * + hint + radio). "How much sun does it get?"
 */
...
import { SUN_EXPOSURE_OPTIONS, SunExposure } from '../types/garden.types';

export interface SunExposurePickerProps {
  value: SunExposure;
  onChange: (value: SunExposure) => void;
}

export function SunExposurePicker({ value, onChange }: SunExposurePickerProps) {
  return (
