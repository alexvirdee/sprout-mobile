/**
 * PlantTypePicker — 2-column grid of selectable plant-type cards (emoji on a
 * soft accent disc). Drop into react-hook-form via a Controller.
 */
...
import { ACCENT_COLORS, PLANT_TYPE_OPTIONS, PlantType } from '../types/plant.types';

export interface PlantTypePickerProps {
  value: PlantType;
  onChange: (value: PlantType) => void;
}

export function PlantTypePicker({ value, onChange }: PlantTypePickerProps) {
  return (
